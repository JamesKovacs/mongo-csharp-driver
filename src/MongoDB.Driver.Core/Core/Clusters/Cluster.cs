...
namespace MongoDB.Driver.Core.Clusters
{
    ...
    internal abstract class Cluster : ICluster
    {
        ...
        protected readonly EventsLogger _clusterEventsLogger;
        protected readonly EventsLogger _serverSelectionEventsLogger;
        ...
        protected Cluster(ClusterSettings settings, IClusterableServerFactory serverFactory, IEventSubscriber eventSubscriber, ILoggerFactory loggerFactory)
        {
            ...
            _clusterEventsLogger = loggerFactory.CreateEventsLogger<ICluster>(eventSubscriber, _clusterId);
            _serverSelectionEventsLogger = loggerFactory.CreateEventsLogger<IServerSelector>(eventSubscriber, _clusterId);
        ...
        public virtual void Initialize()
        {
            ...
            if (_state.TryChange(State.Initial, State.Open))
            {
                ...
                if (_settings.CryptClientSettings != null)
                {
                    ...
                    _clusterEventsLogger.LogDebug("CryptClient created. Shared library version {SharedLibraryVersion}", _cryptClient.CryptSharedLibraryVersion);
                }
            }
        }
