...
namespace MongoDB.Driver.Core.Connections
{
    ...
    internal class BinaryConnection : IConnection
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _eventsLogger = loggerFactory.CreateEventsLogger<IConnection>(eventSubscriber, ConnectionId);
            _commandEventHelper = new CommandEventHelper(loggerFactory.CreateEventsLogger<CommandEventHelper>(eventSubscriber, ConnectionId));
        }
