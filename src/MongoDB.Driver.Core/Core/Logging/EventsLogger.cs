...
using T = MongoDB.Driver.Core.Logging.StructuredLogsTemplates;

namespace MongoDB.Driver.Core.Logging
{
    internal sealed class EventsLogger : LoggerDecorator
    {
        private readonly EventsPublisher _eventsPublisher;
        private bool _isInformationEnabled;

        public EventsLogger(IEventSubscriber eventSubscriber, ILogger logger, string id) :
            base(logger, "Id", id)
        {
        ...
        public bool IsEventTracked<T>() => _isInformationEnabled || _eventsPublisher?.IsEventTracked<T>() == true;
        ...
        public void LogAndPublish(CommandStartedEvent @event)
        {
            ...
            {
                Logger.LogInformation(T.Id_Message_RequestId_CommandName_Command,
                    Id,
                    "Command started",
                    @event.RequestId,
                    @event.CommandName,
        ...
        {
            Logger?.LogInformation(T.Id_Message_RequestId_CommandName,
                Id,
                "Command succeeded",
                @event.RequestId,
                @event.CommandName);
        ...
        {
            Logger?.LogInformation(@event.Failure, T.Id_Message_RequestId_CommandName, Id, "Command failed", @event.RequestId, @event.CommandName);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Failed", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Closing", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Closed", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Opening", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Opened", @event.ServerId);
        ...
        {
            Logger?.LogInformation(@event.Exception, T.Id_Message_ServerId, Id, "Opening failed", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Receiving", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Received", @event.ServerId);
        ...
        {
            Logger?.LogInformation(@event.Exception, T.Id_Message_ServerId, Id, "Receiving failed", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Sending", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Sent", @event.ServerId);
        ...
        {
            Logger?.LogInformation(@event.Exception, T.Id_Message_ServerId, Id, "Sending failed", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Checking out connection");
        ...
        {
            Logger?.LogInformation(T.Id_Message_ConnectionId, Id, "Checked out connection",
                @event.ConnectionId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ConnectionId,
                Id,
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Adding connection");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Opening");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Opened");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Ready");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Closing");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Closed");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Clearing");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Cleared");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Removing");
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Removed");
        ...
        {
            Logger?.LogInformation(T.Id_Message_Description,
                Id,
                "Description changed",
        ...
        {
            Logger?.LogInformation(T.Id_Message_OperationId,
                Id,
                "Selecting server",
                @event.OperationId);
        ...
        {
            Logger?.LogInformation(T.Id_Message, Id, "Adding");
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Added server", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId, Id, "Removing server", @event.ServerId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ServerId_Reason_Duration,
                Id,
                "Removed server",
                @event.ServerId,
                @event.Reason,
        ...
        {
            Logger?.LogInformation(T.Id_Message_Information, Id, "SdamInformation", @event.Message);
        ...
        {
            Logger?.LogInformation(ex, T.Id_Message_Information, Id, "SdamInformation", @event.Message);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ConnectionId, Id, "Heartbeat started", @event.ConnectionId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_ConnectionId, Id, "Heartbeat succeeded", @event.ConnectionId);
        ...
        {
            Logger?.LogInformation(@event.Exception, T.Id_Message_ConnectionId, Id, "Heartbeat failed", @event.ConnectionId);
        ...
        {
            Logger?.LogInformation(T.Id_Message_Description, Id, "Description changed", @event.NewDescription);
