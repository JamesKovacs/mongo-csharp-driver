...
namespace MongoDB.Driver
{
    ...
    public class SetFieldDefinitionsBuilder<TDocument>
    {
        ...
        /// <summary>
        /// Set a field to a value using an expression.
        /// </summary>
        /// <typeparam name="TField">The type of the field.</typeparam>
        /// <param name="field">The field.</param>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Set a field to a value using an Expression to specify the field and an Expression to specify the value.
        /// </summary>
        /// <typeparam name="TField">The type of the field.</typeparam>
        /// <param name="field">The field.</param>
        /// <param name="value">The value.</param>
        /// <returns>An instance of ListSetFieldDefinitions to which further set field definitions can be added.</returns>
        public ListSetFieldDefinitions<TDocument> Set<TField>(Expression<Func<TDocument, TField>> field, Expression<Func<TDocument, TField>> value)
        {
            var setFieldsDefinitions = new ListSetFieldDefinitions<TDocument>(Enumerable.Empty<SetFieldDefinition<TDocument>>());
            return setFieldsDefinitions.Set(field, value);
        }
    ...
    /// </summary>
    public static class SetFieldDefinitionsExtensions
    {
        /// <summary>
        ...
        /// <summary>
        /// Set an additional field to value using an expression.
        /// </summary>
        /// <typeparam name="TDocument">The type of the document.</typeparam>
        /// <typeparam name="TField">The type of the field.</typeparam>
        /// <param name="fields">The existing ListSetFieldDefinitions.</param>
        ...
        /// <summary>
        /// Set an additional field to value using an Expression to specify the field and an Expression to specify the value.
        /// </summary>
        /// <typeparam name="TDocument">The type of the document.</typeparam>
        /// <typeparam name="TField">The type of the field.</typeparam>
        /// <param name="fields">The existing ListSetFieldDefinitions.</param>
        ...
        /// <param name="value">The value.</param>
        /// <returns>The ListSetFieldDefinitions instance with a SetFieldDefinition added.</returns>
        public static ListSetFieldDefinitions<TDocument> Set<TDocument, TField>(this ListSetFieldDefinitions<TDocument> fields, Expression<Func<TDocument, TField>> field, Expression<Func<TDocument, TField>> value)
        {
            var fieldDefinition = new ExpressionFieldDefinition<TDocument, TField>(field);
            var valueDefinition = new ExpressionAggregateExpressionDefinition<TDocument, TField>(value, translationOptions: null);
            var setFieldDefinition = new AggregateExpressionSetFieldDefinition<TDocument, TField>(fieldDefinition, valueDefinition);
            return fields.Set(setFieldDefinition);
        }

        /// <summary>
        /// Set an additional field to value using a SetFieldDefinition.
        /// </summary>
        /// <typeparam name="TDocument">The type of the document.</typeparam>
        /// <param name="fields">The existing ListSetFieldDefinitions.</param>
        /// <param name="setFieldDefinition">The set field definition.</param>
        /// <returns>The ListSetFieldDefinitions instance with a SetFieldDefinition added.</returns>
        public static ListSetFieldDefinitions<TDocument> Set<TDocument>(this ListSetFieldDefinitions<TDocument> fields, SetFieldDefinition<TDocument> setFieldDefinition)
        {
