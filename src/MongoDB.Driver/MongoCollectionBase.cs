...
namespace MongoDB.Driver
{
    ...
    public abstract class MongoCollectionBase<TDocument> : IMongoCollection<TDocument>
    {
        ...
        {
            return DeleteMany(filter, options, (requests, bulkOptions) => BulkWrite(requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteMany(filter, options, (requests, bulkOptions) => BulkWrite(session, requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteManyAsync(filter, options, (requests, bulkOptions) => BulkWriteAsync(requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteManyAsync(filter, options, (requests, bulkOptions) => BulkWriteAsync(session, requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteOne(filter, options, (requests, bulkOptions) => BulkWrite(requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteOne(filter, options, (requests, bulkOptions) => BulkWrite(session, requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteOneAsync(filter, options, (requests, bulkOptions) => BulkWriteAsync(requests, bulkOptions, cancellationToken));
        }
        ...
        {
            return DeleteOneAsync(filter, options, (requests, bulkOptions) => BulkWriteAsync(session, requests, bulkOptions, cancellationToken));
        }
