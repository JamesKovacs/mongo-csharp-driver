...
namespace MongoDB.Driver.Linq.Linq3Implementation.Reflection
{
    internal static class SetWindowFieldsMethod
    {
        ...
        static SetWindowFieldsMethod()
        {
            ...
            __standardDeviationSampleWithDecimal = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, decimal> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithDouble = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, double> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithInt32 = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, int> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithInt64 = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, long> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithNullableDecimal = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, decimal?> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithNullableDouble = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, double?> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithNullableInt32 = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, int?> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithNullableInt64 = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, long?> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithNullableSingle = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, float?> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
            __standardDeviationSampleWithSingle = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, float> selector, WindowBoundaries boundaries) => partition.StandardDeviationSample(selector, boundaries));
