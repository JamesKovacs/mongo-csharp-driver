...
namespace MongoDB.Driver.Linq.Linq3Implementation.Reflection
{
    internal static class SetWindowFieldsMethod
    {
        ...
        static SetWindowFieldsMethod()
        {
            ...
            __derivativeWithDecimalAndUnit = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, decimal> selector, DerivativeTimeUnit unit, WindowBoundaries boundaries) => partition.Derivative(selector, unit, boundaries));
            ...
            __derivativeWithDoubleAndUnit = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, double> selector, DerivativeTimeUnit unit, WindowBoundaries boundaries) => partition.Derivative(selector, unit, boundaries));
            ...
            __derivativeWithInt32AndUnit = ReflectionInfo.Method((ISetWindowFieldsPartition<object> partition, Func<object, int> selector, DerivativeTimeUnit unit, WindowBoundaries boundaries) => partition.Derivative(selector, unit, boundaries));
