...
namespace MongoDB.Driver.Tests.Linq.Linq3ImplementationTests.Jira
{
    public class CSharp3965Tests : Linq3IntegrationTest
    {
        ...
        public void OrderBy_with_expression_should_work()
        {
            ...
            AssertStages(
                stages,
                "{ $project : { _sortedDocument : '$$ROOT', _key1 : { $add : ['$Y', 1] }, _id : 0 } }",
                "{ $sort : { _key1 : 1 } }",
        ...
        public void OrderBy_with_expression_and_ThenBy_with_expression_should_work()
        {
            ...
            AssertStages(
                stages,
                "{ $project : { _sortedDocument : '$$ROOT', _key1 : { $add : ['$X', 1] }, _key2 : { $add : ['$Y', 1] }, _id : 0 } }",
        ...
        public void OrderBy_with_expression_and_ThenBy_with_field_should_work()
        {
            ...
            AssertStages(
                stages,
                "{ $project : { _sortedDocument : '$$ROOT', _key1 : { $add : ['$X', 1] }, _id : 0 } }",
                "{ $sort : { _key1 : 1, '_sortedDocument.Y' : 1 } }",
                "{ $replaceRoot : { newRoot : '$_sortedDocument' } }");
        ...
        public void OrderBy_with_field_and_ThenBy_with_expression_should_work()
        {
            ...
            AssertStages(
                stages,
                "{ $project : { _sortedDocument : '$$ROOT', _key1 : { $add : ['$Y', 1] }, _id : 0 } }",
                "{ $sort : { '_sortedDocument.X' : 1, _key1 : 1 } }",
                "{ $replaceRoot : { newRoot : '$_sortedDocument' } }");
