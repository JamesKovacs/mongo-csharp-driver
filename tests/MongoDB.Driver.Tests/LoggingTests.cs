...
namespace MongoDB.Driver.Tests
{
    public class LoggingTests : LoggableTestClass
    {
        ...
        public void MongoClient_should_log()
        {
            ...
            (LogLevel, string, string) Cluster(string message) => (LogLevel.Debug, LogCatergoryHelper.GetCategoryName<LogCategories.Cluster>(), message);
            (LogLevel, string, string) Connection(string message) => (LogLevel.Debug, LogCatergoryHelper.GetCategoryName<LogCategories.Connection>(), message);
            (LogLevel, string, string) SDAM(string message) => (LogLevel.Debug, LogCatergoryHelper.GetCategoryName<LogCategories.SDAM>(), message);
