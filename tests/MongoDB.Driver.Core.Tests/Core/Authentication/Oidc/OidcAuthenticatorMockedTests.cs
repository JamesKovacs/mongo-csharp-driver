...
//             __defaultAuthenticationContext = new AuthenticationContext(__serverId.EndPoint);
//
...
//                 properties,
//                 isPrincipalNameDifferent ? __defaultAuthenticationContext : new AuthenticationContext(__endpoint2),
//                 serverApi: null,
//                 authenticators); // no mocking
//
//             lazyCache = GetCacheDictionary();
